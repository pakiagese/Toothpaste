...
# Example 2: Detect in a static image
def image_detection(image_path, output_path='output.jpg'):
    ...
    cv2.imshow('Toothpaste Detection (Image)', result)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    print(f"Output saved to '{output_path}'.")

# Run webcam detection by default
if __name__ == "__main__":
    webcam_detection()
    
    # To test on an image, uncomment below:
    # image_detection('path_to_your_toothpaste_image.jpg')
